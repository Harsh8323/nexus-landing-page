...
export function SiteHeader() {
  ...
  />
      ...
      {openMobileNav && <section className="fixed top-30 right-0 bottom-0 left-0 z-40 overflow-hidden bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
